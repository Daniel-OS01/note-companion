...
• With a subscription, you get access to gemini/gemini-2.5-flash model. It's the best all-around model for performance.
...
<strong>Your Files</strong>
  Your files are processed through OpenAI's gemini/gemini-2.5-flash when using the cloud-hosted version.
