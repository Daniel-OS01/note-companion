...
• With a subscription, you get access to models/gemini-2.5-pro model. It's the best all-around model for performance.
...
<strong>Your Files</strong>
  Your files are processed through OpenAI's models/gemini-2.5-pro when using the cloud-hosted version.
